...
| --- | -------------------- | ----------------------------------- | ------------------------------ | ------------------------------------- |
| 1   | Basic routing        | "What is 2+2?"                      | Pass                           |                                       |
| 2   | Streaming            | "Explain git rebase in 3 sentences" | Pass                           |                                       |
| 3   | Model switching      | Same prompt, different models       | Pass (based on return message) |                                       |
| 4   | Tool use — file read | "Read main.py"                      | Pass                           | Pass                                  |
| 5   | Tool use — shell     | "Run git log --oneline -5"          | Fail                           | Output seemed to loop and then stop   |
| 6   | Multi-turn           | Reverse string → add type hints     | Pass                           |                                       |
| 7   | Error recovery       | Bad model key                       | Pass                           | Return message states no model exists |
